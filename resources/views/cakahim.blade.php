    ...
    <div class="container mx-1">
        <div class="card-deck mx-0 px-0">
            <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title text-center">Pasangan 1</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
            ...
            <div class="card">
                <img src="{{asset('img/default_profile.svg')}}" class="card-img-top py-1 mx-auto" style="width: 10rem;" alt="Pasangan 1">
                <div class="card-body">
                <h5 class="card-title text-center">Pasangan 2</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
                <p class="card-text text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio temporibus fugiat eligendi vero, quisquam rerum harum, perferendis optio earum hic commodi assumenda praesentium tempore ut reiciendis nam minima excepturi. Culpa.</p>
                </div>
            ...
            <div class="card">
                <img src="{{asset('img/default_profile.svg')}}" class="card-img-top py-1 mx-auto" style="width: 10rem;" alt="Pasangan 1">
                <div class="card-body">
                <h5 class="card-title text-center">Pasangan 3</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
                <h6 class="text-center">Lorem ipsum - G64170000</h5>
                <p class="card-text text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio temporibus fugiat eligendi vero, quisquam rerum harum, perferendis optio earum hic commodi assumenda praesentium tempore ut reiciendis nam minima excepturi. Culpa.</p>
                </div>
